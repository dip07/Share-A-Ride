...
/**
 * Created by lakshay on 11/28/16.
 */


@RunWith(AndroidJUnit4.class)
public class carCapacityTestCases {
    @Rule
    ...
    @Test
    public void carCapacityTest(){
        UiObject2 firstElement = device.findObject(By.text("Pavithra asked for a ride. Tap to expand"));
        firstElement.click();
